...
function total(){
    ...
    if(grade==2){
        if(hissyuu1nen==26 && hissyuu2nen>=9 && eigo1==4){
            ...
            if(hissyuu2nen<9){
                document.getElementById('cond').innerHTML+=`<li>2年次必修科目を残り${9-hissyuu2nen}単位取得する</li>`;
            }
            if(eigo1<4){
    ...
    if(grade==3){
        if(hissyuu1nen+hissyuu2nen>=47 && suuken==6 && kanrensenmon==6 && sentakuhissyuu>=6 && eigo2==4 && dai2gai==4 && all>=100){
            ...
            if(hissyuu1nen+hissyuu2nen<47){
                document.getElementById('cond').innerHTML+=`<li>1年次必修科目・2年次必修科目を残り${47-hissyuu1nen-hissyuu2nen}単位取得する</li>`;
            }
            if(suuken<6){
            ...
            if(sentakuhissyuu<6){
                document.getElementById('cond').innerHTML+=`<li>選択必修科目を残り${6-sentakuhissyuu}単位取得する</li>`;
            }
            if(eigo2<4){
    ...
    let sentakuhissyuu_amari=sentakuhissyuu-10;
    if(sentakuhissyuu_amari<0) sentakuhissyuu_amari=0;

    if(senmonkiso>=22 && kikankiso>=4 && kanrensenmon>=6 && hissyuu>=38 && sentakuhissyuu>=10 && sentakuhissyuu_amari+sentaku>=14 && eigo1+eigo2>=8 && dai2gai>=4 && kyouyou>=18 && kyouyou3nen>=4){
        ...
        if(senmonkiso<22){
            document.getElementById('cond').innerHTML+=`<li>専門基礎科目を残り${22-senmonkiso}単位取得する</li>`;
        }
        if(kikankiso<4){
        ...
        if(hissyuu<38){
            document.getElementById('cond').innerHTML+=`<li>専門必修科目を残り${38-hissyuu}単位取得する</li>`;
        }
        if(sentakuhissyuu<10 && sentakuhissyuu_amari+sentaku<14){
            document.getElementById('cond').innerHTML+=`<li>専門選択必修科目を残り${10-sentakuhissyuu}単位取得した上で、専門選択必修科目と専門選択科目を合わせて${14-sentakuhissyuu_amari-sentaku}単位取得する</li>`;
        }
        if(sentakuhissyuu<10 && sentaku>=14){
            document.getElementById('cond').innerHTML+=`<li>専門選択必修科目を残り${10-sentakuhissyuu}単位取得する</li>`;
        }
        if(sentakuhissyuu>=10 && sentakuhissyuu_amari+sentaku<14){
            document.getElementById('cond').innerHTML+=`<li>専門選択必修科目と専門選択科目を合わせて${14-sentakuhissyuu_amari-sentaku}単位取得する</li>`;
        }
        if(eigo1+eigo2<8){
